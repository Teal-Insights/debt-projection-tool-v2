...
A working React app, sibling to v1 (`FT Tool`) with same methodology, but with **latest IMF WEO April 2026 data** and the **full WEO universe** (189 economies, 170 fully projectable in the six-year UI).
